          ...
          >
            <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-900 text-white">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold">IA MidiaOS</h3>
                  <p className="text-[10px] text-blue-300 uppercase tracking-widest font-bold">Assistente Conectado</p>
                </div>
              </div>
            ...
            <div className="p-6 border-t border-slate-100 bg-white">
              ...
              >
                <Input
                  ...
                  className="pr-12 h-12 bg-slate-50 border-slate-200 focus:ring-blue-500"
                />
                <button 
                  type="submit"
                  disabled={!input.trim() || loading}
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-blue-600 hover:bg-blue-50 rounded-lg disabled:opacity-30 disabled:hover:bg-transparent"
                >
                  <Send size={20} />
                </button>
              </form>
              <p className="text-[10px] text-center text-slate-400 mt-3 uppercase font-bold tracking-tighter">
                A IA pode cometer erros. Revise ações críticas.
              </p>
            </div>
          </motion.div>
        </>
